      ...
      <form class="cd-form" method="post" action="registerUB.php" >
					...
					<p class="fieldset">
						<label class="image-replace cd-email" for="empsignup-email">E-mail</label>
                                       ...
                                       <p class="fieldset">
						<label class="image-replace cd-email" for="empsignup-address">Address</label>
                                                <input class="full-width has-padding has-border" id="address" name="address" type="address" placeholder="Address">
                                        </p>
					<p class="fieldset">
